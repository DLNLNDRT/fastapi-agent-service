...
def build_tools():
    ...
    @tool
    def chocolate_cake_handler(request: str) -> str:
        """Handle requests for chocolate cake recipes. Use this tool when users ask about making chocolate cake, chocolate cake recipes, or how to bake chocolate cake."""
        
        print(f"[Tool] chocolate_cake_handler called with request: {request}")
        
        # Check if the request is about chocolate cake
        ...
        for keyword in chocolate_cake_keywords:
            if keyword in request_lower:
                return "Sorry, I am not built to help you make chocolate cake."
        
        # If it's not about chocolate cake, return a generic response
        return "This doesn't appear to be a chocolate cake request."
    ...
    def web_search(query: str) -> str:
        ...
        # Check for chocolate cake requests first
    ...
    return [streamlit_playbook, deployment_checklist, chocolate_cake_handler, web_search]
